                   ...
                   <div class="card">
                       <div class="card-header d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-outline-info"id=${taskData.id} onclick="editCard.apply(this, arguments)">
                                <i class="fas fa-pencil"id=${taskData.id} onclick="editCard.apply(this, arguments)"></i>
                            </button>
...
const initialCardLoad=()=>{
        ...
        //loop over those array of task objects to create HTML card and inject it to DOM
...
const deleteCard=(event)=>{
    //event will have the HTML of the selected element
    event=window.event;
    //get id of the element
    const targetID=event.target.id;
    //get the tagname which is either the button or i tag (button was clicked or icon was clicked)
...
//contenteditable is the attribute which will allow us to edit the content
